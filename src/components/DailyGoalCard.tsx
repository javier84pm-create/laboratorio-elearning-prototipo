    ...
    >
      <div
        className={`flex items-center gap-4 p-5 ${
          dailyGoalDone
            ? "bg-[var(--brand-soft)] ring-1 ring-[var(--accent)]/25"
      ...
      >
        <motion.div
          ...
          } ${dailyGoalDone ? "bg-[var(--accent)]/15" : "bg-white"}`}
        ...
        <div className="min-w-0 flex-1">
          <p className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wide text-[var(--ink-muted)]">
            <Sun size={13} /> Meta del día
          </p>
          <h2
            className={`font-display mt-0.5 font-bold text-[var(--ink)] ${
