      ...
      {open ? (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-md overflow-hidden rounded-[1.35rem] border border-[var(--line)] bg-white shadow-[0_24px_60px_rgba(13,107,92,0.22)]"
            initial={{ opacity: 0, y: 18, scale: 0.96 }}
            animate={{ opacity: 1, y: 0, scale: 1 }}
            exit={{ opacity: 0, y: 12, scale: 0.97 }}
            transition={{ type: "spring", stiffness: 380, damping: 28 }}
          >
            <div className="relative bg-gradient-to-br from-[var(--brand)] via-[#0f7a69] to-[var(--accent)] px-5 pb-5 pt-4 text-white">
              <button
                type="button"
